              ...
              {/*desktop navigation */}
               <nav className="hidden md:flex items-center gap-7">
                ...
                <div className="hidden md:flex items-center gap-2" >
                  ...
                  className="px-7 py-3.5 bg-white text-[#212121] font-medium text-base rounded-[17px] border border-white hover:bg-white/90 transition-all duration "
                  >
                    Hire Me
                  </button>
                  </div>
                  ...
                  >
                  <div className="bg-black/95 backdrop-blur-lg border-white/10 px-5 py-5 space- ">
                    {NAV_LINKS.map((link) => (
                    <button 
                    key={link.id}
                    onClick={() => handleNavClick(link.id)}
